...
// 	else m_clrBack=GetSysColor(COLOR_MENU);
	...
	if(state & MF_SEPARATOR){
		...
		m_brSelect.CreateSolidBrush(COLOR_BK_IN);//GetSysColor(COLOR_HIGHLIGHT)
		...
		if(state&ODS_SELECTED){ // draw the down edges
			...
			// draw the up edges	
			pDC->Draw3dRect (rect,COLOR_FG_OUT,COLOR_FG_OUT);
		}
...
void BCMenu::MeasureItem( LPMEASUREITEMSTRUCT lpMIS )
{
	...
	if(state & MF_SEPARATOR){
		...
		//////////////////////////////////////////////////////////////////////////
		//add 2016.6.6
		lpMIS->itemWidth+=SCANB_EXTERN_WIDTH;
		lpMIS->itemHeight+=SCANB_EXTERN_HEIGHT;
		//////////////////////////////////////////////////////////////////////////
		m_fontMenu.DeleteObject();
	}
}
